      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="text" id="username" autoFocus value={username} onChange={(e) => setUsername(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
          </div>
          <div className="mb-6">
